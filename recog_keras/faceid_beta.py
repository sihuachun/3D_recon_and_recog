...
From https://zhuanlan.zhihu.com/p/34863226
...
link_list = ["http://vap.aau.dk/wp-content/uploads/VAPRBGD/(2012-05-16)(151751).zip",
...
print(create_wrong("faceid_train/"))
...
print(create_wrong_rgbd("faceid_val/")[0].shape)
