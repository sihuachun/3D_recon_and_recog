...
class Config():
    training_dir = "/home/aistudio/work/val_datasets/Transform_2D"
    ...
    def create_data_couple():
        data_couple = []
        files = glob.glob(Config.training_dir+'/*.jpg')
        paths = []
        for file_name in files:
            paths.append(os.path.join(Config.training_dir, file_name))
        # 构建数据集地址对
...
if __name__ == "__main__":
    ...
    with fluid.dygraph.guard(place):
        ...
        # 保存模型目录
        model_path = './checkpoint/Transform_2D/transform_2D_epoch9'
        # 加载模型参数
    ...
    csv_path = '/home/aistudio/figure_and_csv/' + 'val_' + Config.training_dir.split('/')[-1] + '.csv'
