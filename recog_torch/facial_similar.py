...
class Config():
    training_dir = "./Facial-Similarity-with-Siamese-Networks-in-Pytorch-master/data/faces/training/"
    testing_dir = "./Facial-Similarity-with-Siamese-Networks-in-Pytorch-master/data/faces/testing/"
    train_batch_size = 64
